...
As the functions in the program and interdependant on some shared variables they are all present in 'journal_file_manager.h' and 'cellstorage.h'. 
...
2. Now run the file by typing './test_case_multi_write' in terminal to run Multiple file write simulation. It can give garbage values at first run (low I/O bandwidth of HD) but on second run it will work fine.
